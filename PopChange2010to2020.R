...
urls <- c(
  "https://jeodpp.jrc.ec.europa.eu/ftp/jrc-opendata/GHSL/GHS_POP_GLOBE_R2023A/GHS_POP_E2010_GLOBE_R2023A_4326_30ss/V1-0/GHS_POP_E2010_GLOBE_R2023A_4326_30ss_V1_0.zip",
...
top_decline_indices <- order(pop_change_values, decreasing = FALSE)[1]  # Top 1 decline
...
top_decline_df <- data.frame(x = top_decline_coords[1], y = top_decline_coords[2], type = "Decline")

# Combine both growth and decline data
highlight_df <- rbind(top_growth_df, top_decline_df)
...
p <- p +
  ...
  scale_color_manual(
    values = c("Growth" = "green", "Decline" = "red")
  )
